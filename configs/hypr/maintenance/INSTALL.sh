...
MAINTENANCE_DIR="${CONF_DIR}/.config/fahmi/hypr/maintenance"
...
run_interactive_step "📥" "Installing necessary packages (using ${BOLD}${aur_helper}${NC})" "${CONF_DIR}/.config/fahmi/hypr/pacman/install-pkgs.sh ${aur_helper}"
